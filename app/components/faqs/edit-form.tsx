...
//   useEffect(() => {
//     if (questionId && languages.length > 0) {
//       const selectedLanguageId = languages[0].languageId; 
//       dispatch(
//         getQuestionDetail({ questionId, languageId: selectedLanguageId })
//       );
//     }
//   }, [dispatch, questionId, languages]);
